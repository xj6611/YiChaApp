...
public class Phone_ValuationActivity extends BaseActivity implements GuJiaContact.View {
    @BindView(R.id.Title)
    TextView Title;
    @BindView(R.id.time)
    TextView time;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_phone__valuation);
