...
public class PC_DatatlisActivity extends BaseActivity implements PC_DatalisContact.View, PC_Data_XRecycleViewAdapter.OnRecyclerviewItemClickListener {
    ...
    private PC_DatalisContact.Presenter presenter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Title.setText(title);
        presenter = new PC_DatalisPresenter(this);
...
//        stringHashMap.entrySet().iterator();
//        while (paramHashMap.hasNext()) {
//            Object localObject2 = (Map.Entry) paramHashMap.next();
//            Object localObject1 = ((Map.Entry) localObject2).getKey();
//            localObject2 = ((Map.Entry) localObject2).getValue();
//            Log.i("asss", "key==" + localObject1 + "val===" + localObject2);
//        }
    }
