package dyc.commlibrary.widget.datepicker;
...
import dyc.commlibrary.widget.datepicker.genview.WheelGeneralAdapter;
...
public class DatePicker extends BaseWheelPick {
    ...
    //选择时间回调
    public void setOnChangeLisener2(OnChangeLisener onChangeLisener2) {
        this.onChangeLisener = onChangeLisener2;
    }
    //选择时间回调
    public void setOnChangeLisener3(OnChangeLisener onChangeLisener2) {
        this.onChangeLisener = onChangeLisener2;
    }
