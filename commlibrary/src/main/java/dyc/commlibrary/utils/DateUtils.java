...
public class DateUtils {
    ...
    public static String formatDate(Date date, String fromFormet) {

        try {
            SimpleDateFormat df = new SimpleDateFormat(fromFormet);
    ...
    public static String dateDiff(long now,long time) {
        long l = now - time;
