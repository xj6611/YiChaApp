...
import com.dyc.piclibrary.ZoomImageView;
...
public class PickBigImagesActivity extends Activity implements ViewPager.OnPageChangeListener, View.OnClickListener{
    ...
    private class MyViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            AlbumBitmapCacheHelper.getInstance(PickBigImagesActivity.this).addPathToShowlist(getPathFromList(position));
            zoomImageView.setTag(getPathFromList(position));
            Bitmap bitmap = AlbumBitmapCacheHelper.getInstance(PickBigImagesActivity.this).getBitmap(getPathFromList(position), 0, 0, new AlbumBitmapCacheHelper.ILoadImageCallback() {
                @Override
        ...
        public void destroyItem(ViewGroup container, int position, Object object) {
            ...
            AlbumBitmapCacheHelper.getInstance(PickBigImagesActivity.this).removePathFromShowlist(getPathFromList(position));
        }
